public class Usuario { //Esta é o usuário interagindo.
    public static void main(String[] args) throws Exception {
        
        SmartTv smartTv = new SmartTv();
/* O 1º SmartTv é como se fosse um int,String,... Aqui nomeamos como smartTv e criamos um novo SmartTv (Orient. a obj.) p/ criar uma classe p/ilustrar a interação dos métodos, atributos, etc.*/
